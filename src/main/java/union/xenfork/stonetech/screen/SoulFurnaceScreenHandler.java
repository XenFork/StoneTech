...
public class SoulFurnaceScreenHandler extends ScreenHandler {
    ...
    public SoulFurnaceScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
    ...
    public SoulFurnaceScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        super(ModScreenHandlers.SOUL_FURNACE_SCREEN_HANDLER, syncId);
        checkSize(((Inventory) blockEntity), 2);
        this.inventory = ((Inventory) blockEntity);
        inventory.onOpen(playerInventory.player);
        this.propertyDelegate = arrayPropertyDelegate;
        this.blockEntity = ((SoulFurnaceBlockEntity) blockEntity);
